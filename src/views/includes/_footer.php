    ...
    <div class="footer__container">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="footer__item">
                        <div class="footer__place-detail">
                            <i class="place-detail__icon ri-map-pin-line"></i>
                        </div>
                        <p class="footer__detail-value">г. Барнаул, Ленина пр-т, 66</p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="footer__item">
                        <div class="footer__place-detail">
                            <i class="place-detail__icon ri-smartphone-line"></i>
                        </div>
                        <p class="footer__detail-value"><a href="#">+7 (938) 234-24-21</a></p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="footer__item">
                        <div class="footer__place-detail">
                            <i class="place-detail__icon ri-mail-unread-line"></i>
                        </div>
                        <p class="footer__detail-value"><a href="#">contact@promusic22.com</a></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer__sub-footer">
            ...
            <div class="footer__copyright-privacy">
                ...
                <span class="copyright-privacy__separator">|</span>
                <a class="copyright-privacy__link" href="#">Условия и положения</a>
            </div>
        </div>
    </div>
</footer>
<header class="header" id="header">
    <div class="header__navbar--sticky">
        <nav class="header-navbar__expand">
            <div class="header-navbar__wrap">
                ...
                <div class="header__navbar-collapse header__navbar-collapse-js">
                    <ul class="header-navbar me-auto mb-2 mb-lg-0">
                        <li class="header-navbar__nav-item">
                            <a class="header-navbar__nav-link active" href="#home">Главная</a>
                        </li>
                        <li class="header-navbar__nav-item">
